...
public class SampleGLInkSurfaceView extends GLInkSurfaceView {
    ...
    private class SampleInkRenderer extends GLInkRenderer {
        ...
        private void executeDraw() {
            ...
            // Clear the canvas in the scissor where the strokes are about to be redrawn
            Rect scissorBox = mScissor.getScissorBox();
            GLES20.glEnable(GLES20.GL_SCISSOR_TEST);
            GLES20.glScissor(scissorBox.left, scissorBox.top, scissorBox.right - scissorBox.left,
                    scissorBox.bottom - scissorBox.top);
            GLES20.glClear(GLES20.GL_COLOR_BUFFER_BIT);
