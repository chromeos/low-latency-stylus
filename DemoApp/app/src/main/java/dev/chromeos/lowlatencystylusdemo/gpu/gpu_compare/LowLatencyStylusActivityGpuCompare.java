...
public class LowLatencyStylusActivityGpuCompare extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Low Latency Stylus - GPU - Compare");
        ...
        // Create a regular GLSurfaceView and add it
        mRegularCanvasSurfaceView = new RegularCanvasSurfaceView(this);
    ...
    public boolean onKeyUp(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_SPACE) {
            ...
            mRegularCanvasSurfaceView.clear();
    ...
    private void selectBrush(int selectedBrush) {
        switch (selectedBrush) {
            case BRUSH_SPRAY:
                ...
                mRegularCanvasSurfaceView.enableSprayPaint(true);
                mRegularCanvasSurfaceView.redrawAll();
            ...
            case BRUSH_NORMAL:
                ...
                mGLInkSurfaceView.redrawAll();
                mRegularCanvasSurfaceView.enableSprayPaint(false);
                mRegularCanvasSurfaceView.redrawAll();
                brushButtons[BRUSH_NORMAL].setBackground(ContextCompat.getDrawable(
                        this, R.drawable.brush_selected));
                brushButtons[BRUSH_SPRAY].setBackground(ContextCompat.getDrawable(
